  ...
  return (
    <div className="ProfileBigCardContainer">
      ...
      <div className="profilepicContainer">
        {myInfo._id === '643cf3eb186a8700143867b4' ? <><img className="profilepic profilepichover" alt="profilepic" src={myInfo.image} onClick={handleShow} /><div className="edit-text text-dark" onClick={handleShow} style={{cursor: 'pointer'}}>Edit Image</div></> : <img className="profilepic" alt="profilepic" src={myInfo.image}/>}
